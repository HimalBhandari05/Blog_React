...
function Home(){
    ...
    // fetch('https://687a74a3abb83744b7eceb2d.mockapi.io/api/v1/blogs' , {
    //     method: 'GET' ,
    //     headers:{
            ...
            <div className="flex flex-wrap gap-10 p-5">
                {
                    blogs.map((blog)=>{
                        return(
                            <Card key={blog.id} blog={blog} title= {blog.title} content={blog.content} createdAt= {blog.createdAt} subtitle={blog.subtitle}/>
                        )
                    })
                }
            </div>
